                ...
                <div class="advanced-search">
                    <form class="search-form" method="get">
                        <div class="col-md-3 col-sm-6 search-col">
                            <input class="form-control keyword" name="keyword" value="" placeholder="Enter Division" type="text">
                            <i class="fa fa-caret-down"></i>
                        </div>
                        <div class="col-md-3 col-sm-6 search-col">
                            <input class="form-control keyword" name="keyword" value="" placeholder="Enter District" type="text">
                            <i class="fa fa-caret-down"></i>
                        </div>
                        <div class="col-md-3 col-sm-6 search-col">
        ...
        <div class="row">
            ...
            <div class="col-sm-9 page-content">
                ...
                <div class="adds-wrapper">
                    <div class="item-list">
                        <div class="col-sm-2 no-padding photobox">
                            <div class="add-image">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/assets/img/item/img-1.jpg" alt=""></a>
                    ...
                    <div class="item-list">
                        <div class="col-sm-2 no-padding photobox">
                            <div class="add-image">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/assets/img/item/img-2.jpg" alt=""></a>
                                <span class="photo-count"><i class="fa fa-camera"></i>2</span>
                            </div>
                        </div>
                        <div class="col-sm-7 add-desc-box">
                    ...
                    <div class="item-list">
                        <div class="col-sm-2 no-padding photobox">
                            <div class="add-image">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/assets/img/item/img-3.jpg" alt=""></a>
                                <span class="photo-count"><i class="fa fa-camera"></i>2</span>
                            </div>
                        </div>
                        <div class="col-sm-7 add-desc-box">
                            <div class="add-details">
                                <h5 class="add-title"><a href="${pageContext.request.contextPath}/resources/ads-details.html">Digital Cameras brand new</a></h5>
                                <div class="info">
                                    <span class="add-type">B</span>
                                    <span class="date">
                                        <i class="fa fa-clock"></i>
                    ...
                    <div class="item-list">
                        <div class="col-sm-2 no-padding photobox">
                            <div class="add-image">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/assets/img/item/img-4.jpg" alt=""></a>
                                <span class="photo-count"><i class="fa fa-camera"></i>2</span>
                            </div>
                        </div>
                        <div class="col-sm-7 add-desc-box">
                    ...
                    <div class="item-list">
                        <div class="col-sm-2 no-padding photobox">
                            <div class="add-image">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/assets/img/item/img-5.jpg" alt=""></a>
                                <span class="photo-count"><i class="fa fa-camera"></i>2</span>
                            </div>
                        </div>
                        <div class="col-sm-7 add-desc-box">
                    ...
                    <div class="item-list">
                        <div class="col-sm-2 no-padding photobox">
                            <div class="add-image">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/assets/img/item/img-6.jpg" alt=""></a>
                                <span class="photo-count"><i class="fa fa-camera"></i>2</span>
                            </div>
                        </div>
                        <div class="col-sm-7 add-desc-box">
                ...
                <div class="post-promo text-center">
                    <h2> Do you get anything for rent ? </h2>
                    <h5>Rent your product online FOR FREE. It's easier than you think !</h5>
